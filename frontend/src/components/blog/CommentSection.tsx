...
import { getBlogComments, addBlogComment } from "@/lib/api";
...
export function CommentSection({ slug }: { slug: string }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    setNotice(null);
    try {
      const created = await addBlogComment(slug, {
        author_name: name.trim(),
        author_email: email.trim() || undefined,
        content: content.trim(),
      });
      // Comments are held for moderation; only show immediately if approved.
